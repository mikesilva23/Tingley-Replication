...
stargazer(data.frame(model1), data.frame(model3)), style = "ajps", type = "latex", omit.summary.stat = c("max", "min", "p25", "p75", "n"), title = "Odor Attraction as a Function of Ideological Similarity", column.sep.width = "20pt", font.size = "Large" )
